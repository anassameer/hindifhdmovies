...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         ...
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🎬 Click Here 🧤", url=f"https://t.me/Hindi_FHD_Movies")]])
    )
    ...
    # don't change anything without contacting me @LazyDeveloperr
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="http://t.me/Anas_688")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
